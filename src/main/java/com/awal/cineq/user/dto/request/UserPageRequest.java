...
/**
 * Request DTO for paginated user list requests.
 * Supports pagination, sorting, search, and filtering by active status.
 */
...
public class UserPageRequest {
    ...
    @Pattern(regexp = "name|email|createdAt|updatedAt", message = "Sort by must be one of: name, email, createdAt, updatedAt")
    @JsonProperty("sortBy")
